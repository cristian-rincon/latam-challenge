...
class TestCloudFunction(unittest.TestCase):
    ...
    def test_fetch_data(self, mock_bigquery_client):
        ...
        mock_results = [
            MagicMock(product_id=1, product_name="Product A", category="Category 1", unit_price=10.5, supplier="Supplier X"),
            MagicMock(product_id=2, product_name="Product B", category="Category 2", unit_price=20.0, supplier="Supplier Y")
        ]
